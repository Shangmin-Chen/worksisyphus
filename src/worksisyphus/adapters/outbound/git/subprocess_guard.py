"""Git Guard Adapter: Implements GitGuardPort using subprocess git commands."""
...
from ....ports.vcs import GitFreshnessResult
...
class SubprocessGitGuard:
    """GitGuardPort implementation using subprocess to query git CLI."""
    ...
    def check_git_freshness(
        ...
        return check_git_freshness_for_sync(
            repo_dir=repo_dir,
