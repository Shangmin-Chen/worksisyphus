"""Domain logic for parsing and validating hand-written plan files."""

from __future__ import annotations

import json

from .models import TAILORED_NAME, Experience, Pick, PlanError, Profile, Project, Selection
...
def parse_plan(text: str, profile: Profile) -> Selection:
    """Parse JSON plan text into a validated domain Selection."""
    try:
