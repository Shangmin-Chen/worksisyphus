...
from ...adapters.outbound.filesystem.rubrics_loader import (
    ROLES_DIR,
    UPSTREAM_MANIFEST_PATH,
)
from ...adapters.outbound.filesystem.rubrics_loader import (
    list_roles as _rubrics_list_roles,
)
from ...adapters.outbound.filesystem.rubrics_loader import (
    load_role as _rubrics_load_role,
)
...
def list_roles() -> list[str]:
    ...
    return _rubrics_list_roles(roles_dir=ROLES_DIR)


def load_role(role_name: str = "startup_product_engineer", jd_text: str | None = None) -> Role:
    """Load a role specification from the roles/ directory, respecting module ROLES_DIR."""
    return _rubrics_load_role(role_name=role_name, jd_text=jd_text, roles_dir=ROLES_DIR)
